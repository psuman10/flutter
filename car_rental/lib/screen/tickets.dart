      ...
      body: Stack(
        children: [
          ListView(
            ...
            children: [
              const Gap(60),
              const Text('Bookings', style: TextStyle(fontSize: 35, fontWeight: FontWeight.w900)),
              const Gap(20),
              FittedBox(
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Center(child: Text('Recent', style: Styles.subtitle1Style.copyWith(fontWeight: FontWeight.w600, color: Styles.textColor),)),
                      ),
                      const Gap(5),
                      Container(
                        width: size.width*0.44,
